...
",
    ...
    private Item GetSampleItem(int id, string authorId, int viewCount, DateTime createdDate)
    {
        ...
        {
            UserId = authorId,
            Title = String.Format($"Item {id} Title"),
            Description = String.Format($"This is a sample description for item {id}: Lorem ipsum dolor sit amet."),
            Notes = "This is a sample record created by the Code-First Configuration class",
            ViewCount = viewCount,
            CreatedDate = createdDate,
    ...
    private Comment GetSampleComment(int n, int itemId, string authorId, DateTime createdDate)
    {
        return new Comment()
        {
            ...
            UserId = authorId,
            ParentId = null,
            Text = String.Format($"Sample comment #{n} for the item #{itemId}"),
            CreatedDate = createdDate,
            LastModifiedDate = createdDate
        };
    }
